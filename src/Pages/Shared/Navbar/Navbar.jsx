    ...
    return (
        <nav className=" p-4 backdrop-blur-lg bg-[#151515] bg-opacity-50">
            <div className="flex justify-between items-center max-w-screen-xl mx-auto">
                ...
                <div>
                    <ul
                        className={`lg:flex lg:space-x-6 space-y-4 lg:space-y-0 absolute lg:static top-16 left-0 w-full bg-gray-800 lg:bg-transparent text-white p-4 lg:p-0 transition-all duration-300 ${
                    ...
                    >
                        ...
                        <li>
                            <Link
                                to="/blog"
                                className={`flex items-center space-x-2 text-lg ${
                                    location.pathname === "/blog" ? "text-teal-600" : ""
                                }`}
                            >
                                <FaBlog />
                                <span>Blog</span>
                        ...
                        <li>
                            <Link
                                to="/product"
                                className={`flex items-center space-x-2 text-lg ${
                                    location.pathname === "/product" ? "text-teal-600" : ""
                                }`}
                            >
                                <FaProductHunt />
                                <span>Product</span>
                        ...
                        <li>
                            <Link
                                to="/contact"
                                className={`flex items-center space-x-2 text-lg hover:text-teal-600 ${
